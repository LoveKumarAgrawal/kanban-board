            ...
            <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
                ...
                <form action={action} className="space-y-6">
                    <div>
                        ...
                        />
                        {state?.errors?.email && (
                            <p className="error text-red-700 text-sm">{state.errors.email}</p>
                        )}
                    </div>
                    <div>
                        ...
                        />
                        {state?.errors?.name && (
                            <p className="error text-red-700 text-sm">{state.errors.name}</p>
                        )}
                    </div>
                    ...
                    <div>
                        ...
                        {state?.errors?.password && (
                            <div className="error text-red-700 text-sm">
                                <p>Password must:</p>
                    ...
                    <div>
                        ...
                        {state?.errors?.confirmPassword && (
                            <p className="error text-red-700 text-sm">{state.errors.confirmPassword}</p>
                        )}
                    </div>
